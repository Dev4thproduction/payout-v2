...
const RoleByID = ({ history }) => {
  ...
  useEffect(() => {
    ...
    if (getRoleByIDData) {
      ...
      setViewAttendance(getRoleByIDData.viewAttendance)
      setRejoinUsers(getRoleByIDData.rejoinUsers)
      setViewFieldTasks(getRoleByIDData.viewFieldTasks)
      setViewUnassignTasks(getRoleByIDData.viewUnassignTasks)
      ...
      setProcessView(getRoleByIDData.processView)
      setProcessAdd(getRoleByIDData.processAdd)
      setProcessUpdate(getRoleByIDData.ProcessUpdate)
      setProcessDelete(getRoleByIDData.ProcessDelete)
      setAssignProcessView(getRoleByIDData.assignProcessView)
      setAssignProcessAdd(getRoleByIDData.assignProcessAdd)
      setAssignProcessUpdate(getRoleByIDData.assignProcessUpdate)
      setAssignProcessDelete(getRoleByIDData.assignProcessDelete)
      setDailyCollectionView(getRoleByIDData.DailyCollectionView)
      setDailyCollectionViewAdd(getRoleByIDData.DailyCollectionViewAdd)
      setDailyCollectionViewUpdate(getRoleByIDData.DailyCollectionViewUpdate)
      setDailyCollectionViewDelete(getRoleByIDData.DailyCollectionViewDelete)
      setMis(getRoleByIDData.mis)
      setDriveNbfcDelhi(getRoleByIDData.driveNbfcDelhi)
      setDriveNbfcHaryana(getRoleByIDData.driveNbfcHaryana)
      setDriveNbfcUp(getRoleByIDData.driveNbfcUp)
      setDriveNbfcTata(getRoleByIDData.driveNbfcTata)
      setDriveHdfcCard(getRoleByIDData.driveHdfcCard)
      setDriveHdfcRetail(getRoleByIDData.driveHdfcRetail)
      setDriveIdfc(getRoleByIDData.driveIdfc)
      setDriveKotak(getRoleByIDData.driveKotak)
